                            ...
                            <table class="table-auto w-full bg-white shadow-md rounded my-6">
                                ...
                                @forelse ($occasions as $occasion)
                                    <tr class="even:bg-white odd:bg-slate-100 border">
                                        <td class="px-4 py-2 text-left">{{ $occasion->brand }} {{$occasion->model}}</td>
                                        <td class="hidden md:table-cell  px-4 py-2 text-left">{{ $occasion->licence_plate }}</td>
                                        @if($occasion->sold)
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center border px-4 py-2">Geen occasions gevonden.</td>
                                    </tr>
                                @endforelse
                                </tbody>
