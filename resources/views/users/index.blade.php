                                    ...
                                    @forelse ($users as $user)
                                        <tr class="even:bg-white odd:bg-slate-100 border">
                                            ...
                                            <td class="text-left px-4 py-2">
                                                <form action="{{ route('dashboard.users.destroy', $user->id) }}" method="post" class="inline-block" onsubmit="return confirm('Weet je zeker dat je deze gebruiker wilt verwijderen?');">
                                                    @csrf
                                                    @method('delete')
